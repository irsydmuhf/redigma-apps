-- =====================================================================
-- Tambah 4 kolom di crm_customers + update sync function
-- =====================================================================
-- Field baru:
-- - district (Kecamatan)
-- - sub_district (Kelurahan)
-- - cs_name (Nama CS yang handle)
-- - platform (Channel/Platform asal: Shopee, TikTok, Meta, dll)
-- =====================================================================
...
-- 2. Update helper function untuk handle 4 kolom baru
  ...
  v_sql := format($s$
    ...
    inserted_or_updated as (
      insert into public.crm_customers as c (
        ...
        district, sub_district, cs_name, platform,
