-- =====================================================================
-- Fix: nama policy ke-truncate kalau nama tabel >=57 char
-- =====================================================================
-- Postgres identifier max 63 char. Kalau nama tabel sudah 63 char,
-- nama policy `${table}_select` jadi ter-truncate ke 63 char juga →
-- bentrok dengan policy lain.
--
-- Solusi: pakai nama policy STATIS (`dataset_select`, `dataset_insert`).
-- Policy name hanya perlu unik per-tabel, bukan global.
-- =====================================================================
...
begin
  ...
  -- Policy name STATIS — scoped per-tabel, tidak bentrok dengan tabel lain
  execute format(
